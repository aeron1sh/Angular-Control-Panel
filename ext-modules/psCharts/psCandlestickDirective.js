        ...
        return {
            ...
            link: function (scope, el, attrs) {
                ...
                scope.$on('psWebMetricsService-received-data-event', function (evt, data) {
                    ...
                    //scope.$watch(function () { return psWebMetricsService.getLiveData(); }, function (newValue) {

                    //if (newValue.time == null) return;
                    ...
                    console.log('d: ' + d.toTimeString());
                    console.log('endTime: ' + scope.period.endTime.toTimeString());
                    console.log('');
